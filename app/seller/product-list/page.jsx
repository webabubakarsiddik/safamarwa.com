...
// Note: router is typically imported from 'next/navigation' (useRouter) in App Router
...
        setLoading(false) // ১. ফিক্স: এরর হলেও লোডিং বন্ধ করতে হবে
      }
    } catch (error) {
      toast.error(error.message) // ২. CRITICAL FIX: 'error.nessage' এর পরিবর্তে 'error.message'
      setLoading(false) // ১. ফিক্স: এরর হলেও লোডিং বন্ধ করতে হবে
    }
  }
